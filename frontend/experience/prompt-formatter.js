export default class PromptFormatter {
    constructor(json) {
        ...
        document.getElementById("prompt-content").innerHTML = `<h1>${this.title}</h1> <div id="prompt-difficulty" class="flex-horizontal"> Difficulty: <div id="difficulty-stars" class="color${this.json["difficulty"]}">${this.difficulty}</div></div> <div id="prompt-description">${this.desc}</div> ${this.cases}`;
    }
